...
totGPs.s <- length(unique(me.df.full.s$group_id)[!grepl("pseu-a",unique(me.df.full.s$group_id))])
...
totGPs.f <- length(unique(me.df.full$group_id)[!grepl("pseu-a",unique(me.df.full$group_id))])
