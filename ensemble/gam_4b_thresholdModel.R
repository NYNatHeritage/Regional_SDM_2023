...
totGPs.s <- length(unique(gam.df.full.s$group_id)[!grepl("pseu-a",unique(gam.df.full.s$group_id))])
...
totGPs.f <- length(unique(gam.df.full$group_id)[!grepl("pseu-a",unique(gam.df.full$group_id))])
